...
public class InsertUpdateGoodTransTableChangeSalableAmountQuery extends BaseQueries {
    @Override
    public Single<IModels> data(IModels iModels) {
        ...
        return Single.create(emitter -> realm.executeTransactionAsync(
                ...
                , error -> {
                    ...
                    ThrowableLoggerHelper.logMyThrowable("InsertUpdateGoodTransTableChangeSalableAmountQuery***data/" + error.getMessage());
                    RealmCloseHelper.closeRealm(realm);
                }
        ));
    }
