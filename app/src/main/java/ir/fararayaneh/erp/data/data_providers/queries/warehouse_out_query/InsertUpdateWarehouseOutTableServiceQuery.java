...
public class InsertUpdateWarehouseOutTableServiceQuery extends BaseQueries {
    ...
    public Single<IModels> data(IModels iModels) {
        ...
        return Single.create(emitter -> {
            ...
            realm.insertOrUpdate(warehouseHandlingListOutTable);
            realm.commitTransaction();
            Log.i("arash", "InsertUpdateWarehouseOutTableServiceQuery: size" + realm.where(WarehouseHandlingListOutTable.class).findAll().size());
