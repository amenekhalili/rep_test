...
import ir.fararayaneh.erp.adaptors.spinner_dialog_adaptor.AddressListSpinnerDialogeAdaptor;
import ir.fararayaneh.erp.adaptors.spinner_dialog_adaptor.CustomerGroupSpinnerDialogeAdaptor;
import ir.fararayaneh.erp.commons.Commons;

public class AddressListSpinnerDialogController extends BaseSpinnerDBDialogController {

    private String b5IdRefId;


    public AddressListSpinnerDialogController(Activity activity, String dialogTitle, String b5IdRefId) {
        super(activity, dialogTitle);
        this.b5IdRefId = b5IdRefId;
    }

    public AddressListSpinnerDialogController(Activity activity, String dialogTitle, String closeTitle,String b5IdRefId) {
        super(activity, dialogTitle, closeTitle);
        this.b5IdRefId = b5IdRefId;
    }

    public AddressListSpinnerDialogController(Activity activity, String dialogTitle, int style,String b5IdRefId) {
        super(activity, dialogTitle, style);
        this.b5IdRefId = b5IdRefId;
    }

    public AddressListSpinnerDialogController(Activity activity, String dialogTitle, int style, String closeTitle,String b5IdRefId) {
    ...
    protected BaseSpinnerDialogDBAdapter getProperNewAdaptor() {
        return new AddressListSpinnerDialogeAdaptor(data);
    }
    ...
    protected BaseSpinnerDialogDBAdapter setupCostumeSearchData(String searchValue) {
        if (searchValue.equals(Commons.SPACE)) {
            data = getSpinnerDialogQueriesInstance().spinnerAddressListMainQuery(getRealmInstance(),b5IdRefId);
            return getProperAdaptorWithData();
        } else {
            data = getSpinnerDialogQueriesInstance().spinnerAddressListSearchQuery(getRealmInstance(),b5IdRefId,searchValue);
            return getProperAdaptorWithData();
        }
    }
