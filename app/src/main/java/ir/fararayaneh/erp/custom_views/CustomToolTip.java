...
public class CustomToolTip {
    ...
    private final CustomToolTip.TooltipView tooltip_view;

    private CustomToolTip(CustomToolTip.MyContext myContext, View view) {
        this.view = view;
        this.tooltip_view = new CustomToolTip.TooltipView(myContext.getContext());
    ...
    private CustomToolTip(CustomToolTip.MyContext myContext, View rootView, View view) {
    ...
    private CustomToolTip(View view) {
        this(new CustomToolTip.MyContext(getActivityContext(view.getContext())), view);
    }

    public static CustomToolTip on(final View view) {
        return new CustomToolTip(new CustomToolTip.MyContext(getActivityContext(view.getContext())), view);
    }

    public static CustomToolTip on(Fragment fragment, final View view) {
        return new CustomToolTip(new CustomToolTip.MyContext(fragment), view);
    }

    public static CustomToolTip on(Activity activity, final View view) {
        return new CustomToolTip(new CustomToolTip.MyContext(getActivityContext(activity)), view);
    }

    public static CustomToolTip on(Activity activity, final View rootView, final View view) {
        return new CustomToolTip(new CustomToolTip.MyContext(getActivityContext(activity)), rootView, view);
    }
    ...
    public CustomToolTip position(CustomToolTip.Position position) {
        this.tooltip_view.setPosition(position);
        return this;
    }

    public CustomToolTip withShadow(boolean withShadow) {
        this.tooltip_view.setWithShadow(withShadow);
        return this;
    }

    public CustomToolTip shadowColor(@ColorInt int shadowColor) {
        this.tooltip_view.setShadowColor(shadowColor);
        return this;
    }

    public CustomToolTip customView(View customView) {
        this.tooltip_view.setCustomView(customView);
        return this;
    }

    public CustomToolTip customView(int viewId) {
        this.tooltip_view.setCustomView(((Activity) view.getContext()).findViewById(viewId));
        return this;
    }

    public CustomToolTip arrowWidth(int arrowWidth) {
        this.tooltip_view.setArrowWidth(arrowWidth);
        return this;
    }

    public CustomToolTip arrowHeight(int arrowHeight) {
        this.tooltip_view.setArrowHeight(arrowHeight);
        return this;
    }

    public CustomToolTip arrowSourceMargin(int arrowSourceMargin) {
        this.tooltip_view.setArrowSourceMargin(arrowSourceMargin);
        return this;
    }

    public CustomToolTip arrowTargetMargin(int arrowTargetMargin) {
        this.tooltip_view.setArrowTargetMargin(arrowTargetMargin);
        return this;
    }

    public CustomToolTip align(CustomToolTip.ALIGN align) {
        this.tooltip_view.setAlign(align);
        return this;
    }

    public CustomToolTip.TooltipView show() {
    ...
    public CustomToolTip duration(long duration) {
        this.tooltip_view.setDuration(duration);
        return this;
    }

    public CustomToolTip color(int color) {
        this.tooltip_view.setColor(color);
        return this;
    }

    public CustomToolTip color(Paint paint) {
        this.tooltip_view.setPaint(paint);
        return this;
    }

    public CustomToolTip onDisplay(CustomToolTip.ListenerDisplay listener) {
        this.tooltip_view.setListenerDisplay(listener);
        return this;
    }

    public CustomToolTip onHide(CustomToolTip.ListenerHide listener) {
        this.tooltip_view.setListenerHide(listener);
        return this;
    }

    public CustomToolTip padding(int left, int top, int right, int bottom) {
    ...
    public CustomToolTip animation(CustomToolTip.TooltipAnimation tooltipAnimation) {
        this.tooltip_view.setTooltipAnimation(tooltipAnimation);
        return this;
    }

    public CustomToolTip text(String text) {
        this.tooltip_view.setText(text);
        return this;
    }

    public CustomToolTip text(@StringRes int text) {
        this.tooltip_view.setText(text);
        return this;
    }

    public CustomToolTip corner(int corner) {
        this.tooltip_view.setCorner(corner);
        return this;
    }

    public CustomToolTip textColor(int textColor) {
        this.tooltip_view.setTextColor(textColor);
        return this;
    }

    public CustomToolTip textTypeFace(Typeface typeface) {
        this.tooltip_view.setTextTypeFace(typeface);
        return this;
    }

    public CustomToolTip textSize(int unit, float textSize) {
        this.tooltip_view.setTextSize(unit, textSize);
        return this;
    }

    public CustomToolTip setTextGravity (int textGravity) {
        this.tooltip_view.setTextGravity(textGravity);
        return this;
    }

    public CustomToolTip clickToHide(boolean clickToHide) {
        this.tooltip_view.setClickToHide(clickToHide);
        return this;
    }

    public CustomToolTip autoHide(boolean autoHide, long duration) {
        this.tooltip_view.setAutoHide(autoHide);
        this.tooltip_view.setDuration(duration);
        return this;
    }

    public CustomToolTip distanceWithView(int distance) {
        this.tooltip_view.setDistanceWithView(distance);
        return this;
    }

    public CustomToolTip border(int color,float width){
    ...
    public static class FadeTooltipAnimation implements CustomToolTip.TooltipAnimation {
    ...
    public static class TooltipView extends FrameLayout {
        ...
        private CustomToolTip.Position position = CustomToolTip.Position.BOTTOM;
        private CustomToolTip.ALIGN align = CustomToolTip.ALIGN.CENTER;
        private boolean clickToHide;
        private boolean autoHide = true;
        private long duration = 4000;

        private CustomToolTip.ListenerDisplay listenerDisplay;

        private CustomToolTip.ListenerHide listenerHide;

        private CustomToolTip.TooltipAnimation tooltipAnimation = new CustomToolTip.FadeTooltipAnimation();
        ...
        public void setPosition(CustomToolTip.Position position) {
        ...
        public void setAlign(CustomToolTip.ALIGN align) {
            this.align = align;
            postInvalidate();
        }
        ...
        public void setListenerDisplay(CustomToolTip.ListenerDisplay listener) {
            this.listenerDisplay = listener;
        }

        public void setListenerHide(CustomToolTip.ListenerHide listener) {
            this.listenerHide = listener;
        }

        public void setTooltipAnimation(CustomToolTip.TooltipAnimation tooltipAnimation) {
            ...
            tooltipAnimation.animateEnter(this, new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    if (listenerDisplay != null) {
                        listenerDisplay.onDisplay(CustomToolTip.TooltipView.this);
                    }
                }
            });
        }
            ...
            tooltipAnimation.animateExit(this, new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    if (listenerHide != null) {
                        listenerHide.onHide(CustomToolTip.TooltipView.this);
                    }
                }
            });
        }
        ...
        public void setupPosition(Rect rect) {
            ...
            if (position == CustomToolTip.Position.LEFT || position == CustomToolTip.Position.RIGHT) {
                if (position == CustomToolTip.Position.LEFT) {
                ...
                if (position == CustomToolTip.Position.BOTTOM) {
        ...
        private Path drawBubble(RectF myRect, float topLeftDiameter, float topRightDiameter, float bottomRightDiameter, float bottomLeftDiameter) {
            ...
            final float spacingLeft = this.position == CustomToolTip.Position.RIGHT ? arrowHeight : 0;
            final float spacingTop = this.position == CustomToolTip.Position.BOTTOM ? arrowHeight : 0;
            final float spacingRight = this.position == CustomToolTip.Position.LEFT ? arrowHeight : 0;
            final float spacingBottom = this.position == CustomToolTip.Position.TOP ? arrowHeight : 0;
            ...
            final float arrowSourceX = (Arrays.asList(CustomToolTip.Position.TOP, CustomToolTip.Position.BOTTOM).contains(this.position))
                    ? centerX + arrowSourceMargin
                    : centerX;
            final float arrowTargetX = (Arrays.asList(CustomToolTip.Position.TOP, CustomToolTip.Position.BOTTOM).contains(this.position))
                    ? centerX + arrowTargetMargin
                    : centerX;
            final float arrowSourceY = (Arrays.asList(CustomToolTip.Position.RIGHT, CustomToolTip.Position.LEFT).contains(this.position))
                    ? bottom / 2f - arrowSourceMargin
                    : bottom / 2f;
            final float arrowTargetY = (Arrays.asList(CustomToolTip.Position.RIGHT, CustomToolTip.Position.LEFT).contains(this.position))
            ...
            if (position == CustomToolTip.Position.TOP) {
            ...
            if (position == CustomToolTip.Position.RIGHT) {
        ...
        public boolean adjustSize(Rect rect, int screenWidth) {
            ...
            if (position == CustomToolTip.Position.LEFT && getWidth() > rect.left) {
                layoutParams.width = rect.left - MARGIN_SCREEN_BORDER_TOOLTIP - distanceWithView;
                changed = true;
            } else if (position == CustomToolTip.Position.RIGHT && rect.right + getWidth() > screenWidth) {
                layoutParams.width = screenWidth - rect.right - MARGIN_SCREEN_BORDER_TOOLTIP - distanceWithView;
                changed = true;
            } else if (position == CustomToolTip.Position.TOP || position == CustomToolTip.Position.BOTTOM) {
                ...
                if((rect.centerX() + getWidth() / 2f) > screenWidth){
                    ...
                    setAlign(CustomToolTip.ALIGN.CENTER);
                    changed = true;
        ...
        public void removeNow() {
            if (getParent() != null) {
                ...
                parent.removeView(CustomToolTip.TooltipView.this);
            }
        }
